...
Original file is located at
    https://colab.research.google.com/drive/1PQe3crHb_0XDjMI61Mj1tvKiLxFDfspG
"""
...
ds = pd.read_csv('/content/Training.csv')
...
len(ds['prognosis'].unique())

"""this is already shorten data so we dont want  to do feature selection
